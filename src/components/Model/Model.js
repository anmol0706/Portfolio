...
export const Model = ({
  ...
  useEffect(() => {
    ...
    renderer.current.useLegacyLights = false;
    renderer.current.toneMapping = NoToneMapping;
    ...
    // Lighting - reduced intensity to preserve original image colors
...
const Device = ({
  ...
  useEffect(() => {
    const applyScreenTexture = async (texture, node) => {
      ...
      // Set material properties to display original texture colors
